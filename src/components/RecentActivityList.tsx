...
export default function RecentActivityList({ activities }: { activities: ActivityRecord[] }) {
    return (
                                    ...
                                    <div className="flex justify-between items-start">
                                        <div>
                                            ...
                                            <p className="text-xs text-slate-500 mt-0.5">
                                                {record.type === 'CHECK_IN' ? 'Giriş yaptı' : 'Çıkış yaptı'} • {formatDistanceToNow(date, { addSuffix: true, locale: tr })}
                                            </p>
                                        </div>
