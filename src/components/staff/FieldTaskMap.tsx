...
export default function FieldTaskMap() {
    ...
    return (
        <div className="flex flex-col h-[calc(100vh-140px)] gap-4">
            {/* Map Placeholder - In real app use react-leaflet or Google Maps */}
                    ...
                    {TASKS.map((task) => (
                        ...
                        >
                            ...
                            <div className="text-right">
                                <span className="block text-xs font-bold text-slate-700">{task.time}</span>
                                <span className="block text-[10px] text-slate-400">{task.distance}</span>
                            </div>
                        </div>
                    ))}
                </div>
