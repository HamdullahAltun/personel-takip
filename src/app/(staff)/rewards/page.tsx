...
import { Gift, Coins, ShoppingBag, Loader2 } from "lucide-react";
    ...
    const handleBuy = async (reward: Reward) => {
        ...
        try {
            ...
            if (res.ok) {
                ...
                // Ideally refresh rewards to check stock
            } else {
        ...
        <div className="max-w-md mx-auto min-h-screen pb-24 bg-slate-50">
            ...
            <div className="p-6 grid grid-cols-2 gap-4">
                {rewards.map(reward => {
                    ...
                    return (
                        <div key={reward.id} className="bg-white rounded-2xl p-4 shadow-sm border border-slate-100 flex flex-col h-full">
